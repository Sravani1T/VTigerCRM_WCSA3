...
public class CreateAndDuplicateLeadTest {
	...
	public static void main(String[] args) {
		...
		if(newLeadInfo.getPageHeader().contains(leadName))
			System.out.println("created lead Info page displayed");
		else
			System.out.println("created lead Info page not displayed");
		...
		if(duplicating.getPageHeader().contains(leadName))
			...
			System.out.println("duplicate lead page not displayed");
